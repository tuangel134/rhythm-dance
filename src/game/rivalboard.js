...
export class RivalBoard {
  ...
  constructor(container, beatmap, settings) {
    ...
    this.stage = new Stage(container, this.laneCount, (settings && settings.scrollSpeed) || 3, {}, { mode: (settings && settings.gameMode) || "dance", piuSkin: (settings && settings.piuSkin) || null });
